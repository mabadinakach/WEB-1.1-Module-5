...
app.config["MONGO_URI"] = "mongodb+srv://marcos:Man1795002@cluster-web.21qxh.mongodb.net/WEB1-1?retryWrites=true&w=majority"
...
def edit(plant_id):
    ...
    if request.method == 'POST':
        ...
        mongo.db.plants.update_one(search_param, changes)
